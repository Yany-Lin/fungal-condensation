...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{{Supplementary Figures}/SuppFig2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{{Supplementary Figures}/SuppFig3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig5.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig6.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig7.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig8.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig9.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig10.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig11.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig12.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig13.pdf}
\caption{\textbf{Absorbing capacity, specific surface area, and erosion survival.} \textbf{(A)}~Absorbing capacity $\mathcal{A} = f_{\mathrm{tissue}} \times d_{\mathrm{structure}}$ (per-ROI box plot; $n = 13$ \textit{Aspergillus}, $n = 11$ \textit{Mucor}). The two factors of the decomposition are reported as main-text Figure~4 panels F (hyphal area fraction $f_{\mathrm{tissue}}$) and D (median structure thickness $d_{\mathrm{structure}}$). \textbf{(B)}~Specific surface area (perimeter / tissue area). \textit{Mucor} exhibits $1.78\times$ higher SSA than \textit{Aspergillus} ($p = 7 \times 10^{-7}$); the inversion of this ordering relative to vapor-sink strength rules out surface-to-volume ratio as the operative quantity and supports the absorbing-capacity (mass-per-footprint) framework. \textbf{(C)}~Erosion survival fraction at iteration~10, an ROI-level robustness check on light-microscopy tissue masks ($n = 6$ \textit{Aspergillus}, $n = 3$ \textit{Mucor}; $2.13\times$, Welch's $p = 7.9 \times 10^{-5}$, $d = 4.75$). The iteration sequence on which this scalar is computed is shown in Supplementary Fig.~\ref{fig:supp_erosion}. Boxes: IQR; whiskers: 1.5$\times$IQR.}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig14.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{{Supplementary Figures}/SuppFig15.pdf}
